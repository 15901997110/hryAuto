...
public class UserDefaultTest extends UserBase{
    ...
    public void accountFacade_balanceCheckDetail(HryTest hryTest) {
        String actual = this._accountFacade_balanceCheckDetail(hryTest);
    ...
    public void accountFacade_queryAccount(HryTest hryTest) {
        String actual = this._accountFacade_queryAccount(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_queryAccountBalanceByUserId(HryTest hryTest) {
        String actual = this._accountFacade_queryAccountBalanceByUserId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_queryAccountByUserId(HryTest hryTest) {
        String actual = this._accountFacade_queryAccountByUserId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_queryAccountFlowBackEnd(HryTest hryTest) {
        String actual = this._accountFacade_queryAccountFlowBackEnd(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_queryUserInfoCheckFileResult(HryTest hryTest) {
        String actual = this._accountFacade_queryUserInfoCheckFileResult(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_queryUserInfoCheckFileResultDetails(HryTest hryTest) {
        String actual = this._accountFacade_queryUserInfoCheckFileResultDetails(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void accountFacade_userCheckDetail(HryTest hryTest) {
        String actual = this._accountFacade_userCheckDetail(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_activateStockedUser(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_activateStockedUser(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_auditBindCard(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_auditBindCard(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_bindCardGeneral(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_bindCardGeneral(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_checkPassword(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_checkPassword(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_enterpriseBindBankcard(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_enterpriseBindBankcard(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_enterpriseInformationUpdate(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_enterpriseInformationUpdate(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_enterpriseRegister(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_enterpriseRegister(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_modifyMobile(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_modifyMobile(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_personalBindBankcardExpand(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_personalBindBankcardExpand(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_personalRegister(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_personalRegister(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_queryUserInformation(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_queryUserInformation(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_resetPassword(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_resetPassword(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void lanmaoGatewayFacade_userAuthorization(HryTest hryTest) {
        String actual = this._lanmaoGatewayFacade_userAuthorization(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loanQuotaFacade_freezeLoanAmount(HryTest hryTest) {
        String actual = this._loanQuotaFacade_freezeLoanAmount(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loanQuotaFacade_queryLoanQuota(HryTest hryTest) {
        String actual = this._loanQuotaFacade_queryLoanQuota(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loanQuotaFacade_returnLoanAmount(HryTest hryTest) {
        String actual = this._loanQuotaFacade_returnLoanAmount(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loanQuotaFacade_unfreezeLoanAmount(HryTest hryTest) {
        String actual = this._loanQuotaFacade_unfreezeLoanAmount(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loanQuotaFacade_useLoanAmount(HryTest hryTest) {
        String actual = this._loanQuotaFacade_useLoanAmount(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_generateCode(HryTest hryTest) {
        String actual = this._loginFacade_generateCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_getUserInfoByToken(HryTest hryTest) {
        String actual = this._loginFacade_getUserInfoByToken(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_inLoginRisk(HryTest hryTest) {
        String actual = this._loginFacade_inLoginRisk(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_sendEmailAuthCode(HryTest hryTest) {
        String actual = this._loginFacade_sendEmailAuthCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_sendMobileAuthCode(HryTest hryTest) {
        String actual = this._loginFacade_sendMobileAuthCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_sendMobileAuthCodeByToken(HryTest hryTest) {
        String actual = this._loginFacade_sendMobileAuthCodeByToken(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_updateBindingMobile(HryTest hryTest) {
        String actual = this._loginFacade_updateBindingMobile(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_updateLoginPassword(HryTest hryTest) {
        String actual = this._loginFacade_updateLoginPassword(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_updateLoginPasswordByOriginPassword(HryTest hryTest) {
        String actual = this._loginFacade_updateLoginPasswordByOriginPassword(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_validateEmailAuthCode(HryTest hryTest) {
        String actual = this._loginFacade_validateEmailAuthCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_validateIdCardNo(HryTest hryTest) {
        String actual = this._loginFacade_validateIdCardNo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void loginFacade_validateMobileAuthCode(HryTest hryTest) {
        String actual = this._loginFacade_validateMobileAuthCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void nonInvestorFacade_getPlatformUserInfoByUserNo(HryTest hryTest) {
        String actual = this._nonInvestorFacade_getPlatformUserInfoByUserNo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void nonInvestorFacade_setSubRole(HryTest hryTest) {
        String actual = this._nonInvestorFacade_setSubRole(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void oauthFacade_getAccessCode(HryTest hryTest) {
        String actual = this._oauthFacade_getAccessCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void oauthFacade_getUserIdByToken(HryTest hryTest) {
        String actual = this._oauthFacade_getUserIdByToken(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void oauthFacade_queryTokenByAccessCode(HryTest hryTest) {
        String actual = this._oauthFacade_queryTokenByAccessCode(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void oauthFacade_refreshAccessToken(HryTest hryTest) {
        String actual = this._oauthFacade_refreshAccessToken(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void oauthFacade_validateOauthClient(HryTest hryTest) {
        String actual = this._oauthFacade_validateOauthClient(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void riskManagermentFacade_cardModigyRiskManager(HryTest hryTest) {
        String actual = this._riskManagermentFacade_cardModigyRiskManager(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void riskManagermentFacade_loginRiskManager(HryTest hryTest) {
        String actual = this._riskManagermentFacade_loginRiskManager(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void riskManagermentFacade_openDepositoryRiskManager(HryTest hryTest) {
        String actual = this._riskManagermentFacade_openDepositoryRiskManager(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void riskManagermentFacade_registerRiskManager(HryTest hryTest) {
        String actual = this._riskManagermentFacade_registerRiskManager(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }

    @Test(testName = "/userCommonFacade/clearCache", dataProvider = "provider", description = "根据缓存key清理缓存")
    public void userCommonFacade_clearCache(HryTest hryTest) {
        String actual = this._userCommonFacade_clearCache(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userCommonFacade_getAllCacheNames(HryTest hryTest) {
        String actual = this._userCommonFacade_getAllCacheNames(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }

    @Test(testName = "/userCommonFacade/viewCacheDetail", dataProvider = "provider", description = "查看缓存值")
    public void userCommonFacade_viewCacheDetail(HryTest hryTest) {
        String actual = this._userCommonFacade_viewCacheDetail(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_addUserExtraInfo(HryTest hryTest) {
        String actual = this._userConsoleFacade_addUserExtraInfo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_deleteUserExtraAttachment(HryTest hryTest) {
        String actual = this._userConsoleFacade_deleteUserExtraAttachment(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_executeTask(HryTest hryTest) {
        String actual = this._userConsoleFacade_executeTask(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_getAllAccountType(HryTest hryTest) {
        String actual = this._userConsoleFacade_getAllAccountType(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_getBankAuditDetail(HryTest hryTest) {
        String actual = this._userConsoleFacade_getBankAuditDetail(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryAccountflow(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryAccountflow(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryAuthUsers(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryAuthUsers(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryBankAuditList(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryBankAuditList(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryEnterpriseDetail(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryEnterpriseDetail(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryPersonalDetail(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryPersonalDetail(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_queryUserList(HryTest hryTest) {
        String actual = this._userConsoleFacade_queryUserList(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_resetWrongTimes(HryTest hryTest) {
        String actual = this._userConsoleFacade_resetWrongTimes(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_riskAudit(HryTest hryTest) {
        String actual = this._userConsoleFacade_riskAudit(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_upateUserState(HryTest hryTest) {
        String actual = this._userConsoleFacade_upateUserState(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userConsoleFacade_uploadBankAuditFile(HryTest hryTest) {
        String actual = this._userConsoleFacade_uploadBankAuditFile(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_checkBankCardAudit(HryTest hryTest) {
        String actual = this._userFacade_checkBankCardAudit(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_checkEnterpriseUpdateProcess(HryTest hryTest) {
        String actual = this._userFacade_checkEnterpriseUpdateProcess(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_checkLoginNameExists(HryTest hryTest) {
        String actual = this._userFacade_checkLoginNameExists(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getAuth(HryTest hryTest) {
        String actual = this._userFacade_getAuth(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getBankCardBindingList(HryTest hryTest) {
        String actual = this._userFacade_getBankCardBindingList(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getBaseInfoByUserIds(HryTest hryTest) {
        String actual = this._userFacade_getBaseInfoByUserIds(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getEnterpriseInfoByLoginName(HryTest hryTest) {
        String actual = this._userFacade_getEnterpriseInfoByLoginName(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getEnterpriseInfoByUserId(HryTest hryTest) {
        String actual = this._userFacade_getEnterpriseInfoByUserId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getInvestProfit(HryTest hryTest) {
        String actual = this._userFacade_getInvestProfit(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getPersonalInfoByLoginName(HryTest hryTest) {
        String actual = this._userFacade_getPersonalInfoByLoginName(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getPersonalInfoByUserId(HryTest hryTest) {
        String actual = this._userFacade_getPersonalInfoByUserId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getPersonalRealName(HryTest hryTest) {
        String actual = this._userFacade_getPersonalRealName(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getPersonalRealNameByUserIds(HryTest hryTest) {
        String actual = this._userFacade_getPersonalRealNameByUserIds(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getUnionUserByLoginName(HryTest hryTest) {
        String actual = this._userFacade_getUnionUserByLoginName(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getUserIdWithSameIdCardNo(HryTest hryTest) {
        String actual = this._userFacade_getUserIdWithSameIdCardNo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getUserInfoByLoginName(HryTest hryTest) {
        String actual = this._userFacade_getUserInfoByLoginName(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getUserInfoByUserId(HryTest hryTest) {
        String actual = this._userFacade_getUserInfoByUserId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_getUserProperty(HryTest hryTest) {
        String actual = this._userFacade_getUserProperty(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_initInvestorUser(HryTest hryTest) {
        String actual = this._userFacade_initInvestorUser(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_isCunguanTestingUser(HryTest hryTest) {
        String actual = this._userFacade_isCunguanTestingUser(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_queryBankList(HryTest hryTest) {
        String actual = this._userFacade_queryBankList(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_updateEnterpriseBankCardInfo(HryTest hryTest) {
        String actual = this._userFacade_updateEnterpriseBankCardInfo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_updateEnterpriseBaseInfo(HryTest hryTest) {
        String actual = this._userFacade_updateEnterpriseBaseInfo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_updateEnterpriseLegalInfo(HryTest hryTest) {
        String actual = this._userFacade_updateEnterpriseLegalInfo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_updateGroupId(HryTest hryTest) {
        String actual = this._userFacade_updateGroupId(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_updateUserInfo(HryTest hryTest) {
        String actual = this._userFacade_updateUserInfo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
    ...
    public void userFacade_verifyPasswordByRequestNo(HryTest hryTest) {
        String actual = this._userFacade_verifyPasswordByRequestNo(hryTest);
        AssertUtil.supperAssert(actual, hryTest);
    }
