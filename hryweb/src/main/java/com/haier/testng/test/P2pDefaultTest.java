...
public class P2pDefaultTest extends P2pBase{
    ...
    public void agreementFacade_addProductInstruction(HryTest hryTest) {
        String actual = super._agreementFacade_addProductInstruction(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/agreementFacade/getAgreementListByBidId", dataProvider = "provider", description = "查询标的对应的出借人协议列表")
    public void agreementFacade_getAgreementListByBidId(HryTest hryTest) {
        String actual = super._agreementFacade_getAgreementListByBidId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getAgreementTemplate(HryTest hryTest) {
        String actual = super._agreementFacade_getAgreementTemplate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getBidAgreement(HryTest hryTest) {
        String actual = super._agreementFacade_getBidAgreement(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getHuijinAgreementTemplate(HryTest hryTest) {
        String actual = super._agreementFacade_getHuijinAgreementTemplate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getHuijinContract(HryTest hryTest) {
        String actual = super._agreementFacade_getHuijinContract(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getProductContract(HryTest hryTest) {
        String actual = super._agreementFacade_getProductContract(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getProductInstructionList(HryTest hryTest) {
        String actual = super._agreementFacade_getProductInstructionList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getProductInstructions(HryTest hryTest) {
        String actual = super._agreementFacade_getProductInstructions(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_getTransferOfDebtContract(HryTest hryTest) {
        String actual = super._agreementFacade_getTransferOfDebtContract(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_queryProductInstruction(HryTest hryTest) {
        String actual = super._agreementFacade_queryProductInstruction(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void agreementFacade_updateProductInstructions(HryTest hryTest) {
        String actual = super._agreementFacade_updateProductInstructions(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void alterNativeRechargeFacade_addAlterNativeRecharge(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_addAlterNativeRecharge(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/generateBatchProduct", dataProvider = "provider", description = "批量发标")
    public void alterNativeRechargeFacade_generateBatchProduct(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_generateBatchProduct(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/generateProduct", dataProvider = "provider", description = "发标接口")
    public void alterNativeRechargeFacade_generateProduct(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_generateProduct(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/getBatchReleaseLog", dataProvider = "provider", description = "批量发标记录查询")
    public void alterNativeRechargeFacade_getBatchReleaseLog(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_getBatchReleaseLog(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/queryAlterNativeRechargeList", dataProvider = "provider", description = "查询代充值列表")
    public void alterNativeRechargeFacade_queryAlterNativeRechargeList(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_queryAlterNativeRechargeList(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/queryEntrustPayOrder", dataProvider = "provider", description = "【console】查询委托支付授权订单")
    public void alterNativeRechargeFacade_queryEntrustPayOrder(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_queryEntrustPayOrder(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/alterNativeRechargeFacade/queryProductByCreditId", dataProvider = "provider", description = "确认发标是否成功")
    public void alterNativeRechargeFacade_queryProductByCreditId(HryTest hryTest) {
        String actual = super._alterNativeRechargeFacade_queryProductByCreditId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void assetsResourceFacade_loan(HryTest hryTest) {
        String actual = super._assetsResourceFacade_loan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void assetsResourceFacade_queryAssets(HryTest hryTest) {
        String actual = super._assetsResourceFacade_queryAssets(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void assetsResourceFacade_updateAssfinance(HryTest hryTest) {
        String actual = super._assetsResourceFacade_updateAssfinance(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getAggregatedBidDetail(HryTest hryTest) {
        String actual = super._bidFacade_getAggregatedBidDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getBidCategoryList(HryTest hryTest) {
        String actual = super._bidFacade_getBidCategoryList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getBidDetailByIdList(HryTest hryTest) {
        String actual = super._bidFacade_getBidDetailByIdList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getBidIsNoviceProperty(HryTest hryTest) {
        String actual = super._bidFacade_getBidIsNoviceProperty(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getBidRuleConfigById(HryTest hryTest) {
        String actual = super._bidFacade_getBidRuleConfigById(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getBidTypeList(HryTest hryTest) {
        String actual = super._bidFacade_getBidTypeList(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/bidFacade/getMatchBidDetailInfo", dataProvider = "provider", description = "匹配详情页面信息")
    public void bidFacade_getMatchBidDetailInfo(HryTest hryTest) {
        String actual = super._bidFacade_getMatchBidDetailInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_getTotalAmountBybidAndUser(HryTest hryTest) {
        String actual = super._bidFacade_getTotalAmountBybidAndUser(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryBidDetailByIdList(HryTest hryTest) {
        String actual = super._bidFacade_queryBidDetailByIdList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryBidListCond(HryTest hryTest) {
        String actual = super._bidFacade_queryBidListCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryBidRuleConfigByCondition(HryTest hryTest) {
        String actual = super._bidFacade_queryBidRuleConfigByCondition(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryCouponBidListByQueryCond(HryTest hryTest) {
        String actual = super._bidFacade_queryCouponBidListByQueryCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryExchangeInfo(HryTest hryTest) {
        String actual = super._bidFacade_queryExchangeInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_queryLcjBidListByQueryCond(HryTest hryTest) {
        String actual = super._bidFacade_queryLcjBidListByQueryCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_saveBidRuleConfig(HryTest hryTest) {
        String actual = super._bidFacade_saveBidRuleConfig(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_updateBidIsNoviceProperty(HryTest hryTest) {
        String actual = super._bidFacade_updateBidIsNoviceProperty(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_updateBidRuleConfig(HryTest hryTest) {
        String actual = super._bidFacade_updateBidRuleConfig(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void bidFacade_updateBidRuleConfigEnabledStatus(HryTest hryTest) {
        String actual = super._bidFacade_updateBidRuleConfigEnabledStatus(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void calculateFacade_getAnnualRate(HryTest hryTest) {
        String actual = super._calculateFacade_getAnnualRate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_addRpLabel(HryTest hryTest) {
        String actual = super._cfFacade_addRpLabel(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_caculateCfRepayPlan(HryTest hryTest) {
        String actual = super._cfFacade_caculateCfRepayPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_createReserveOrder(HryTest hryTest) {
        String actual = super._cfFacade_createReserveOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_examineOrAbandonCfPlan(HryTest hryTest) {
        String actual = super._cfFacade_examineOrAbandonCfPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_generateCfReservationPlan(HryTest hryTest) {
        String actual = super._cfFacade_generateCfReservationPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getCfAgreementTemplate(HryTest hryTest) {
        String actual = super._cfFacade_getCfAgreementTemplate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getCfReservationPlan(HryTest hryTest) {
        String actual = super._cfFacade_getCfReservationPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getCfReserveInvestPage(HryTest hryTest) {
        String actual = super._cfFacade_getCfReserveInvestPage(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getCfReserveOrderDetail(HryTest hryTest) {
        String actual = super._cfFacade_getCfReserveOrderDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getCfReserveOrderPage(HryTest hryTest) {
        String actual = super._cfFacade_getCfReserveOrderPage(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getInvestmentProperty(HryTest hryTest) {
        String actual = super._cfFacade_getInvestmentProperty(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getInvestorInfoByBidId(HryTest hryTest) {
        String actual = super._cfFacade_getInvestorInfoByBidId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getMyInvestPlanRecord(HryTest hryTest) {
        String actual = super._cfFacade_getMyInvestPlanRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getMyReservationOrderInfo(HryTest hryTest) {
        String actual = super._cfFacade_getMyReservationOrderInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getPlanAssetDetail(HryTest hryTest) {
        String actual = super._cfFacade_getPlanAssetDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getPlanTradeDetail(HryTest hryTest) {
        String actual = super._cfFacade_getPlanTradeDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getReservationPlanOrder(HryTest hryTest) {
        String actual = super._cfFacade_getReservationPlanOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getReservationPlanOrderDetail(HryTest hryTest) {
        String actual = super._cfFacade_getReservationPlanOrderDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getReserveOrderByRequestNo(HryTest hryTest) {
        String actual = super._cfFacade_getReserveOrderByRequestNo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_getReserveOrderDetail(HryTest hryTest) {
        String actual = super._cfFacade_getReserveOrderDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_listCfBidBorrowDetail(HryTest hryTest) {
        String actual = super._cfFacade_listCfBidBorrowDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryBiddingOrder(HryTest hryTest) {
        String actual = super._cfFacade_queryBiddingOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryCfBidByCfPlan(HryTest hryTest) {
        String actual = super._cfFacade_queryCfBidByCfPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryCfOrderByCfPlan(HryTest hryTest) {
        String actual = super._cfFacade_queryCfOrderByCfPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryCfPlanByCondition(HryTest hryTest) {
        String actual = super._cfFacade_queryCfPlanByCondition(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryCfPlanDetail(HryTest hryTest) {
        String actual = super._cfFacade_queryCfPlanDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryCouponReservationPlanByCond(HryTest hryTest) {
        String actual = super._cfFacade_queryCouponReservationPlanByCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryRepayRecord(HryTest hryTest) {
        String actual = super._cfFacade_queryRepayRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryReservationPlanByStatus(HryTest hryTest) {
        String actual = super._cfFacade_queryReservationPlanByStatus(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryReservationPlanDetail(HryTest hryTest) {
        String actual = super._cfFacade_queryReservationPlanDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryReservationPlanOrder(HryTest hryTest) {
        String actual = super._cfFacade_queryReservationPlanOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_queryUnfreezeOrders(HryTest hryTest) {
        String actual = super._cfFacade_queryUnfreezeOrders(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void cfFacade_removeRpLabel(HryTest hryTest) {
        String actual = super._cfFacade_removeRpLabel(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void frontEndFacade_listReservationPlan(HryTest hryTest) {
        String actual = super._frontEndFacade_listReservationPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void frontEndFacade_queryNoviceBidDetail(HryTest hryTest) {
        String actual = super._frontEndFacade_queryNoviceBidDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void frontEndFacade_queryNoviceBidList(HryTest hryTest) {
        String actual = super._frontEndFacade_queryNoviceBidList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_applyDebtSale(HryTest hryTest) {
        String actual = super._huijinPlanFacade_applyDebtSale(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_changeDebtType(HryTest hryTest) {
        String actual = super._huijinPlanFacade_changeDebtType(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_freezeAndApplyDebtSale(HryTest hryTest) {
        String actual = super._huijinPlanFacade_freezeAndApplyDebtSale(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_freezeDebt(HryTest hryTest) {
        String actual = super._huijinPlanFacade_freezeDebt(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_getBidRecordIdByDebtId(HryTest hryTest) {
        String actual = super._huijinPlanFacade_getBidRecordIdByDebtId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_getDebtInfo(HryTest hryTest) {
        String actual = super._huijinPlanFacade_getDebtInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_getDebtInfoByBidRecordId(HryTest hryTest) {
        String actual = super._huijinPlanFacade_getDebtInfoByBidRecordId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_getTradingRepayment(HryTest hryTest) {
        String actual = super._huijinPlanFacade_getTradingRepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_lockDebt(HryTest hryTest) {
        String actual = super._huijinPlanFacade_lockDebt(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_loseDebt(HryTest hryTest) {
        String actual = super._huijinPlanFacade_loseDebt(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_transferDebt(HryTest hryTest) {
        String actual = super._huijinPlanFacade_transferDebt(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_unfreezeAndCancelDebtSale(HryTest hryTest) {
        String actual = super._huijinPlanFacade_unfreezeAndCancelDebtSale(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void huijinPlanFacade_unfreezeDebt(HryTest hryTest) {
        String actual = super._huijinPlanFacade_unfreezeDebt(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/ibsQueryFacade/getIbsInvestInfo", dataProvider = "provider", description = "获取智能投标的投资信息")
    public void ibsQueryFacade_getIbsInvestInfo(HryTest hryTest) {
        String actual = super._ibsQueryFacade_getIbsInvestInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_createInvestOrder(HryTest hryTest) {
        String actual = super._investFacade_createInvestOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getBiddingStatusByVoucherNo(HryTest hryTest) {
        String actual = super._investFacade_getBiddingStatusByVoucherNo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getInvestmentInfo(HryTest hryTest) {
        String actual = super._investFacade_getInvestmentInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getInvestmentProperty(HryTest hryTest) {
        String actual = super._investFacade_getInvestmentProperty(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getInvestStatusByOrderId(HryTest hryTest) {
        String actual = super._investFacade_getInvestStatusByOrderId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getInvestStatusByRequestNo(HryTest hryTest) {
        String actual = super._investFacade_getInvestStatusByRequestNo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getMyInvestDetail(HryTest hryTest) {
        String actual = super._investFacade_getMyInvestDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getNumberOfBidders(HryTest hryTest) {
        String actual = super._investFacade_getNumberOfBidders(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getOfflineOrder(HryTest hryTest) {
        String actual = super._investFacade_getOfflineOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getOfflineProperty(HryTest hryTest) {
        String actual = super._investFacade_getOfflineProperty(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_getUserPurchaseRecordListByHryId(HryTest hryTest) {
        String actual = super._investFacade_getUserPurchaseRecordListByHryId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_intelligentInvest(HryTest hryTest) {
        String actual = super._investFacade_intelligentInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_investCountStatistics(HryTest hryTest) {
        String actual = super._investFacade_investCountStatistics(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_investCountStatisticsByHryId(HryTest hryTest) {
        String actual = super._investFacade_investCountStatisticsByHryId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_noviceCheck(HryTest hryTest) {
        String actual = super._investFacade_noviceCheck(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryAllPrincipalAndInterestReceived(HryTest hryTest) {
        String actual = super._investFacade_queryAllPrincipalAndInterestReceived(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryInvestByCond(HryTest hryTest) {
        String actual = super._investFacade_queryInvestByCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryInvestRecord(HryTest hryTest) {
        String actual = super._investFacade_queryInvestRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryMyInvest(HryTest hryTest) {
        String actual = super._investFacade_queryMyInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryPurchaseCondByHryIdList(HryTest hryTest) {
        String actual = super._investFacade_queryPurchaseCondByHryIdList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryPurchaseRecordList(HryTest hryTest) {
        String actual = super._investFacade_queryPurchaseRecordList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryRepaymentRecordList(HryTest hryTest) {
        String actual = super._investFacade_queryRepaymentRecordList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investFacade_queryTotalMoney(HryTest hryTest) {
        String actual = super._investFacade_queryTotalMoney(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investReservationFacade_addShortMsgBlackList(HryTest hryTest) {
        String actual = super._investReservationFacade_addShortMsgBlackList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investReservationFacade_getInvestReservationList(HryTest hryTest) {
        String actual = super._investReservationFacade_getInvestReservationList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investReservationFacade_getShortMsgBlackList(HryTest hryTest) {
        String actual = super._investReservationFacade_getShortMsgBlackList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void investReservationFacade_removeFromBlackList(HryTest hryTest) {
        String actual = super._investReservationFacade_removeFromBlackList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_loanByBid(HryTest hryTest) {
        String actual = super._loanFacade_loanByBid(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_loanNotify(HryTest hryTest) {
        String actual = super._loanFacade_loanNotify(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_queryLoanBid(HryTest hryTest) {
        String actual = super._loanFacade_queryLoanBid(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_queryLoanBidDetail(HryTest hryTest) {
        String actual = super._loanFacade_queryLoanBidDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_queryLoanOrder(HryTest hryTest) {
        String actual = super._loanFacade_queryLoanOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_queryUserLoanOrders(HryTest hryTest) {
        String actual = super._loanFacade_queryUserLoanOrders(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_resendContractMq(HryTest hryTest) {
        String actual = super._loanFacade_resendContractMq(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void loanFacade_specifyTransfer(HryTest hryTest) {
        String actual = super._loanFacade_specifyTransfer(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/messageFacade/sendMessage", dataProvider = "provider", description = "发送消息")
    public void messageFacade_sendMessage(HryTest hryTest) {
        String actual = super._messageFacade_sendMessage(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_abandonInvest(HryTest hryTest) {
        String actual = super._offlinePlanFacade_abandonInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_addBatchOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_addBatchOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_addOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_addOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_crmInvest(HryTest hryTest) {
        String actual = super._offlinePlanFacade_crmInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_getOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_getOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_getOfflinePlanDetail(HryTest hryTest) {
        String actual = super._offlinePlanFacade_getOfflinePlanDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_getUserInvestOrder(HryTest hryTest) {
        String actual = super._offlinePlanFacade_getUserInvestOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_getWhetherInvest(HryTest hryTest) {
        String actual = super._offlinePlanFacade_getWhetherInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_invalidOrder(HryTest hryTest) {
        String actual = super._offlinePlanFacade_invalidOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_listOfflineIssuerAndConsignee(HryTest hryTest) {
        String actual = super._offlinePlanFacade_listOfflineIssuerAndConsignee(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_listOfflineRepayOrder(HryTest hryTest) {
        String actual = super._offlinePlanFacade_listOfflineRepayOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_listReleaseOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_listReleaseOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_queryInvestByPage(HryTest hryTest) {
        String actual = super._offlinePlanFacade_queryInvestByPage(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_queryOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_queryOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/offlinePlanFacade/resetOfflineOrderStatus", dataProvider = "provider", description = "【傲融】认购计划重新发起扣款")
    public void offlinePlanFacade_resetOfflineOrderStatus(HryTest hryTest) {
        String actual = super._offlinePlanFacade_resetOfflineOrderStatus(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_resetOfflineRepayOrder(HryTest hryTest) {
        String actual = super._offlinePlanFacade_resetOfflineRepayOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_setOnOffOfOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_setOnOffOfOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_updateOfflinePlan(HryTest hryTest) {
        String actual = super._offlinePlanFacade_updateOfflinePlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_updateOfflineRepayDate(HryTest hryTest) {
        String actual = super._offlinePlanFacade_updateOfflineRepayDate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_updateUserInvestOrder(HryTest hryTest) {
        String actual = super._offlinePlanFacade_updateUserInvestOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void offlinePlanFacade_userInvest(HryTest hryTest) {
        String actual = super._offlinePlanFacade_userInvest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void orderFacade_getRealTimePurchaseRecord(HryTest hryTest) {
        String actual = super._orderFacade_getRealTimePurchaseRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void orderFacade_getRepaymentStatusByOrderIdList(HryTest hryTest) {
        String actual = super._orderFacade_getRepaymentStatusByOrderIdList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void orderFacade_queryPurchaseRecord(HryTest hryTest) {
        String actual = super._orderFacade_queryPurchaseRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void orderFacade_queryPurchaseRecordDetail(HryTest hryTest) {
        String actual = super._orderFacade_queryPurchaseRecordDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void platformMarkingFacade_addAlterNativeRecharge(HryTest hryTest) {
        String actual = super._platformMarkingFacade_addAlterNativeRecharge(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void platformMarkingFacade_creatPlatformMarking(HryTest hryTest) {
        String actual = super._platformMarkingFacade_creatPlatformMarking(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void platformMarkingFacade_queryAlterNativeList(HryTest hryTest) {
        String actual = super._platformMarkingFacade_queryAlterNativeList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void platformMarkingFacade_selectUserInfo(HryTest hryTest) {
        String actual = super._platformMarkingFacade_selectUserInfo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/queryTransferOfDebtFacades/getMyAssetByTransferOfDebt", dataProvider = "provider", description = "获取我的债转投资资产信息")
    public void queryTransferOfDebtFacades_getMyAssetByTransferOfDebt(HryTest hryTest) {
        String actual = super._queryTransferOfDebtFacades_getMyAssetByTransferOfDebt(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/queryTransferOfDebtFacades/getRepaymentDetail", dataProvider = "provider", description = "获取回款债转详情")
    public void queryTransferOfDebtFacades_getRepaymentDetail(HryTest hryTest) {
        String actual = super._queryTransferOfDebtFacades_getRepaymentDetail(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/queryTransferOfDebtFacades/listMyTransferOfDebt", dataProvider = "provider", description = "获取我的债转投资列表信息")
    public void queryTransferOfDebtFacades_listMyTransferOfDebt(HryTest hryTest) {
        String actual = super._queryTransferOfDebtFacades_listMyTransferOfDebt(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/queryTransferOfDebtFacades/listRepaymentDetails", dataProvider = "provider", description = "获取回款债转列表")
    public void queryTransferOfDebtFacades_listRepaymentDetails(HryTest hryTest) {
        String actual = super._queryTransferOfDebtFacades_listRepaymentDetails(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void realtimeStatisticsFacade_getBidAndCFRealtimeStatistics(HryTest hryTest) {
        String actual = super._realtimeStatisticsFacade_getBidAndCFRealtimeStatistics(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_createAdjustAccountOrder(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_createAdjustAccountOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_createRechargeOrder(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_createRechargeOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_createWithdrawOrder(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_createWithdrawOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_directWithdraw(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_directWithdraw(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/rechargeAndWithdrawFacade/p2pDirectRecharge", dataProvider = "provider", description = "自动充值")
    public void rechargeAndWithdrawFacade_p2pDirectRecharge(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_p2pDirectRecharge(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryAdjustAccountOrder(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryAdjustAccountOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryRechargeList(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryRechargeList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryRechargeRecord(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryRechargeRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryRechargeRecordDetail(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryRechargeRecordDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryWithdrawList(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryWithdrawList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryWithdrawRecord(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryWithdrawRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_queryWithdrawRecordDetail(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_queryWithdrawRecordDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void rechargeAndWithdrawFacade_sumWithdrawPending(HryTest hryTest) {
        String actual = super._rechargeAndWithdrawFacade_sumWithdrawPending(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void reconFacade_queryBackrollReconciliation(HryTest hryTest) {
        String actual = super._reconFacade_queryBackrollReconciliation(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void reconFacade_queryCommissionInfo(HryTest hryTest) {
        String actual = super._reconFacade_queryCommissionInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void reconFacade_queryRechargeReconciliation(HryTest hryTest) {
        String actual = super._reconFacade_queryRechargeReconciliation(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void reconFacade_queryReconInfo(HryTest hryTest) {
        String actual = super._reconFacade_queryReconInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void reconFacade_queryWithdrawReconciliation(HryTest hryTest) {
        String actual = super._reconFacade_queryWithdrawReconciliation(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void regionFacade_getSubRegion(HryTest hryTest) {
        String actual = super._regionFacade_getSubRegion(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void regionFacade_regionInfo(HryTest hryTest) {
        String actual = super._regionFacade_regionInfo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/repaymentFacade/autoPrepayment", dataProvider = "provider", description = "融资人提前代扣还款")
    public void repaymentFacade_autoPrepayment(HryTest hryTest) {
        String actual = super._repaymentFacade_autoPrepayment(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/repaymentFacade/financierAutoRepayment", dataProvider = "provider", description = "融资人代扣还款")
    public void repaymentFacade_financierAutoRepayment(HryTest hryTest) {
        String actual = super._repaymentFacade_financierAutoRepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_financierRepayment(HryTest hryTest) {
        String actual = super._repaymentFacade_financierRepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_financierRepaymentWithExinterest(HryTest hryTest) {
        String actual = super._repaymentFacade_financierRepaymentWithExinterest(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_financierStatistics(HryTest hryTest) {
        String actual = super._repaymentFacade_financierStatistics(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getBidHkjh(HryTest hryTest) {
        String actual = super._repaymentFacade_getBidHkjh(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getFinancierRepaymentOrder(HryTest hryTest) {
        String actual = super._repaymentFacade_getFinancierRepaymentOrder(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getInvestorRepaymentDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_getInvestorRepaymentDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getPrepaymentCompensationOrderDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_getPrepaymentCompensationOrderDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getRepayingDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_getRepayingDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_getReserveRepaymentDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_getReserveRepaymentDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listFinancierRepaymentOrders(HryTest hryTest) {
        String actual = super._repaymentFacade_listFinancierRepaymentOrders(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listFinancierRepaymentOrdersConsole(HryTest hryTest) {
        String actual = super._repaymentFacade_listFinancierRepaymentOrdersConsole(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listFinancierRepaymentPlans(HryTest hryTest) {
        String actual = super._repaymentFacade_listFinancierRepaymentPlans(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listInvestorRepaymentDetails(HryTest hryTest) {
        String actual = super._repaymentFacade_listInvestorRepaymentDetails(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listInvestorRepaymentDetailsConsole(HryTest hryTest) {
        String actual = super._repaymentFacade_listInvestorRepaymentDetailsConsole(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_listPrepaymentCompensationConsole(HryTest hryTest) {
        String actual = super._repaymentFacade_listPrepaymentCompensationConsole(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_prepayment(HryTest hryTest) {
        String actual = super._repaymentFacade_prepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_prepaymentApplication(HryTest hryTest) {
        String actual = super._repaymentFacade_prepaymentApplication(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryBiddersHkjh(HryTest hryTest) {
        String actual = super._repaymentFacade_queryBiddersHkjh(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryCfBiddingOrderHkjh(HryTest hryTest) {
        String actual = super._repaymentFacade_queryCfBiddingOrderHkjh(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryExistsPrepaymentPlan(HryTest hryTest) {
        String actual = super._repaymentFacade_queryExistsPrepaymentPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryPerfectHkjh(HryTest hryTest) {
        String actual = super._repaymentFacade_queryPerfectHkjh(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryPrepaymentApplication(HryTest hryTest) {
        String actual = super._repaymentFacade_queryPrepaymentApplication(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryPrepaymentPlan(HryTest hryTest) {
        String actual = super._repaymentFacade_queryPrepaymentPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryRepayingBids(HryTest hryTest) {
        String actual = super._repaymentFacade_queryRepayingBids(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryRepaymentBids(HryTest hryTest) {
        String actual = super._repaymentFacade_queryRepaymentBids(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryRepaymentDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_queryRepaymentDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryRepaymentList(HryTest hryTest) {
        String actual = super._repaymentFacade_queryRepaymentList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryReserveRepaymentDetails(HryTest hryTest) {
        String actual = super._repaymentFacade_queryReserveRepaymentDetails(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_querySettledBids(HryTest hryTest) {
        String actual = super._repaymentFacade_querySettledBids(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/repaymentFacade/queryUeBidRepaymentPlan", dataProvider = "provider", description = "查询优易智投标的借款人还款计划（Console使用）")
    public void repaymentFacade_queryUeBidRepaymentPlan(HryTest hryTest) {
        String actual = super._repaymentFacade_queryUeBidRepaymentPlan(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_queryUnpaidBidDetail(HryTest hryTest) {
        String actual = super._repaymentFacade_queryUnpaidBidDetail(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_rebuildInvestorRepaymentDetailsConsole(HryTest hryTest) {
        String actual = super._repaymentFacade_rebuildInvestorRepaymentDetailsConsole(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_rebuildPrepaymentCompensationConsole(HryTest hryTest) {
        String actual = super._repaymentFacade_rebuildPrepaymentCompensationConsole(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void repaymentFacade_reserveRepayment(HryTest hryTest) {
        String actual = super._repaymentFacade_reserveRepayment(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/riskLevelFacade/listRiskLevelInfo", dataProvider = "provider", description = "风险等级信息")
    public void riskLevelFacade_listRiskLevelInfo(HryTest hryTest) {
        String actual = super._riskLevelFacade_listRiskLevelInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void stockPrepaymentApplyFacade_applyStockPrepayment(HryTest hryTest) {
        String actual = super._stockPrepaymentApplyFacade_applyStockPrepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void stockPrepaymentApplyFacade_listStockPrepayment(HryTest hryTest) {
        String actual = super._stockPrepaymentApplyFacade_listStockPrepayment(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void stockPrepaymentApplyFacade_listStockPrepaymentByIds(HryTest hryTest) {
        String actual = super._stockPrepaymentApplyFacade_listStockPrepaymentByIds(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_addBatchEnclosure(HryTest hryTest) {
        String actual = super._tenderFacade_addBatchEnclosure(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_addBidExtraInfo(HryTest hryTest) {
        String actual = super._tenderFacade_addBidExtraInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_addBidLabel(HryTest hryTest) {
        String actual = super._tenderFacade_addBidLabel(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_agreeTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_agreeTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_checkReleaseQueueBidValiad(HryTest hryTest) {
        String actual = super._tenderFacade_checkReleaseQueueBidValiad(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_deleteEnclosure(HryTest hryTest) {
        String actual = super._tenderFacade_deleteEnclosure(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_deleteLabelInfo(HryTest hryTest) {
        String actual = super._tenderFacade_deleteLabelInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_disagreeTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_disagreeTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_discardTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_discardTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getBidExtraInfo(HryTest hryTest) {
        String actual = super._tenderFacade_getBidExtraInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getEnclosure(HryTest hryTest) {
        String actual = super._tenderFacade_getEnclosure(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getLabelInfos(HryTest hryTest) {
        String actual = super._tenderFacade_getLabelInfos(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getLabelInfosByBid(HryTest hryTest) {
        String actual = super._tenderFacade_getLabelInfosByBid(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getRepayPlanPage(HryTest hryTest) {
        String actual = super._tenderFacade_getRepayPlanPage(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_getTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getTenderBidList(HryTest hryTest) {
        String actual = super._tenderFacade_getTenderBidList(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_getUserLogDetailPageInfo(HryTest hryTest) {
        String actual = super._tenderFacade_getUserLogDetailPageInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_miscarryBid(HryTest hryTest) {
        String actual = super._tenderFacade_miscarryBid(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_preReleaseTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_preReleaseTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_queryBidListByQueueId(HryTest hryTest) {
        String actual = super._tenderFacade_queryBidListByQueueId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_queryBidReleaseQueueByCond(HryTest hryTest) {
        String actual = super._tenderFacade_queryBidReleaseQueueByCond(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_releaseTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_releaseTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_saveBidReleaseQueue(HryTest hryTest) {
        String actual = super._tenderFacade_saveBidReleaseQueue(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_settingScheduleReleaseTime(HryTest hryTest) {
        String actual = super._tenderFacade_settingScheduleReleaseTime(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_submitBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_submitBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_updateLabel(HryTest hryTest) {
        String actual = super._tenderFacade_updateLabel(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void tenderFacade_updateTenderBidInfo(HryTest hryTest) {
        String actual = super._tenderFacade_updateTenderBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/getMatchBidRemarkByIds", dataProvider = "provider", description = "根据标的Id集合获取对应流标退标备注(管理后台使用)")
    public void uePlanFacade_getMatchBidRemarkByIds(HryTest hryTest) {
        String actual = super._uePlanFacade_getMatchBidRemarkByIds(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/getUeMatchedInfo", dataProvider = "provider", description = "根据优易智投授权订单获取匹配信息 - (uePlan系统)")
    public void uePlanFacade_getUeMatchedInfo(HryTest hryTest) {
        String actual = super._uePlanFacade_getUeMatchedInfo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/listAuthOrderProfitAmount", dataProvider = "provider", description = "根据授权码集合,获取对应的收益")
    public void uePlanFacade_listAuthOrderProfitAmount(HryTest hryTest) {
        String actual = super._uePlanFacade_listAuthOrderProfitAmount(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/listBidByUeAuthRequestNo", dataProvider = "provider", description = "根据优易智投授权订单获取匹配标的列表 - (前端)")
    public void uePlanFacade_listBidByUeAuthRequestNo(HryTest hryTest) {
        String actual = super._uePlanFacade_listBidByUeAuthRequestNo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/listMatchingBid", dataProvider = "provider", description = "获取待匹配的标的信息")
    public void uePlanFacade_listMatchingBid(HryTest hryTest) {
        String actual = super._uePlanFacade_listMatchingBid(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/listMyStandardBid", dataProvider = "provider", description = "获取我的散标 - （前端，我的出借）")
    public void uePlanFacade_listMyStandardBid(HryTest hryTest) {
        String actual = super._uePlanFacade_listMyStandardBid(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/listUeBidStatisticsInfo", dataProvider = "provider", description = "获取优易智投下标的统计信息 - (uePlan系统)")
    public void uePlanFacade_listUeBidStatisticsInfo(HryTest hryTest) {
        String actual = super._uePlanFacade_listUeBidStatisticsInfo(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/queryUeMatchedBidHkjh", dataProvider = "provider", description = "查询优易匹配标的还款计划/匹配详情 - (前端)")
    public void uePlanFacade_queryUeMatchedBidHkjh(HryTest hryTest) {
        String actual = super._uePlanFacade_queryUeMatchedBidHkjh(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/uePlanFacade/queryUeMatchedBidInfo", dataProvider = "provider", description = "优易智投标的信息查询(供ueplan使用)")
    public void uePlanFacade_queryUeMatchedBidInfo(HryTest hryTest) {
        String actual = super._uePlanFacade_queryUeMatchedBidInfo(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_annualInvestmentAmount(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_annualInvestmentAmount(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_getInvestmentTotalAmount(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_getInvestmentTotalAmount(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_loanCalculate(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_loanCalculate(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_queryBidOrderByBidRecordId(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_queryBidOrderByBidRecordId(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_queryBidOrderByOrderId(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_queryBidOrderByOrderId(hryTest);
        supperAssert(actual, hryTest);
    }

    @Test(testName = "/yyTradeStatFacade/queryInvestmentRecord", dataProvider = "provider", description = "根据客户端ID,加密后的user id,查询该用户的所有投资记录")
    public void yyTradeStatFacade_queryInvestmentRecord(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_queryInvestmentRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_queryTenderRecordRecord(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_queryTenderRecordRecord(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_totalInvestmentAmount(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_totalInvestmentAmount(hryTest);
        supperAssert(actual, hryTest);
    }
    ...
    public void yyTradeStatFacade_twoAnniversary(HryTest hryTest) {
        String actual = super._yyTradeStatFacade_twoAnniversary(hryTest);
        supperAssert(actual, hryTest);
    }
