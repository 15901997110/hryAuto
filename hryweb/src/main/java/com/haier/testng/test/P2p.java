...
public class P2p {
    ...
    @Test(testName = "/cfFacade/getCfAgreementTemplate", dataProvider = "provider", description = "根据消金协议模版")
    ...
    @Test(testName = "/cfFacade/getMyReservationOrderInfo", dataProvider = "provider", description = "获取我的预约信息")
    ...
    @Test(testName = "/cfFacade/getPlanTradeDetail", dataProvider = "provider", description = "根据预约计划查询交易详情")
    ...
    @Test(testName = "/cfFacade/getReservationPlanOrder", dataProvider = "provider", description = "根据预约订单号查询预约详情")
    ...
    @Test(testName = "/cfFacade/queryCfReserveRepayRecord", dataProvider = "provider", description = "回款-预约列表")
    public void cfFacade_queryCfReserveRepayRecord(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/cfFacade/queryReservationPlanOrder", dataProvider = "provider", description = "我的预约")
    ...
    @Test(testName = "/cfFacade/unfreezeFund", dataProvider = "provider", description = "手动触发解冻Job执行")
    public void cfFacade_unfreezeFund(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/repaymentFacade/doRepay", dataProvider = "provider", description = "【console】代偿、还款")
    public void repaymentFacade_doRepay(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
