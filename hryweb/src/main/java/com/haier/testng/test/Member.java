...
public class Member {
    ...
    @Test(testName = "/customerFacade/checkMobileVerifyCode", dataProvider = "provider", description = "找回登录密码过程--校验手机短信验证码")
    public void customerFacade_checkMobileVerifyCode(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/customerFacade/emailConfirmRetrieveLoginPw", dataProvider = "provider", description = "找回登录密码过程--邮件确认接口")
    public void customerFacade_emailConfirmRetrieveLoginPw(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/customerFacade/getResetLoginPasswordInfo", dataProvider = "provider", description = "找回登录密码过程--获取重置登录密码信息接口")
    public void customerFacade_getResetLoginPasswordInfo(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/customerFacade/loginPasswordReset", dataProvider = "provider", description = "找回登录密码过程--重置登录密码接口")
    public void customerFacade_loginPasswordReset(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
    ...
    @Test(testName = "/customerFacade/sendResetLoginPasswordEmail", dataProvider = "provider", description = "找回登录密码过程--发送邮件接口")
    public void customerFacade_sendResetLoginPasswordEmail(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }

    @Test(testName = "/customerFacade/sendVerifyCodeMessage", dataProvider = "provider", description = "找回登录密码过程--发送短信校验码")
    public void customerFacade_sendVerifyCodeMessage(Params params) {
        Reporter.log("用例设计参数 : ");
        Reporter.log(params.getTcase().getRequestparam());
        Assert.assertTrue(this.getBoolResult(params));
    }
